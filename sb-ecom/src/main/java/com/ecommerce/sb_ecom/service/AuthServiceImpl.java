...
public class AuthServiceImpl implements AuthService {
    ...
    public ResponseEntity<MessageResponse> register(SignupRequest signUpRequest) {
        ...
        // Public registration must never be allowed to choose privileged roles.
    ...
    public UserResponse getAllSellers(Pageable pageable) {
        ...
        List<UserDTO> userDtos = allUsers.getContent().stream().map(p -> modelMapper.map(p, UserDTO.class)).collect(Collectors.toList());
